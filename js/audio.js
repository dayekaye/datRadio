...
var source, sourceJs;
var analyser;
var url = 'data/MAGNOLIA_MIX_4-20.mp3';
var array = new Array();
var boost = 0;
...
request.onload = function() {
	context.decodeAudioData(
		...
		function(buffer) {
			...
			//this is where the array is created that the visualizer interacts with
			...
			$('#info')
				.fadeOut('normal', function() {
					$(this).html('<div id="artist"><a class="name" href="https://soundcloud.com/theonlyjprizzle/magnolia"target="_blank">Magnolia</a><br/><a class="song"href="https://soundcloud.com/theonlyjprizzle"target="_blank">theonlyjprizzle</a><br /></div><div><a href="info"><img src="images/toCC.png" width="58" height="58"/></div>');
				})
				.fadeIn();
